...
//	}
	...
	/*
	 * @RequestMapping( "/list/pageNum/{pageNum}/search/{search}/keyword/{keyword}")
	 * public String search2(@PathVariable String pageNum,
	 * 
	...
	@RequestMapping("infoShareSpecific")		// 댓글 비동기식 받기 rest api
	public String infoShareSpecific(int num, String pageNum, Model model) {
